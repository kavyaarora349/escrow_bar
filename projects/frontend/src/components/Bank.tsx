          ...
          if (t.innerTxns && t.innerTxns.length > 0) {
            ...
            for (const innerTxn of t.innerTxns) {
              if (innerTxn.paymentTransaction) {
                ...
                console.log('Found payment in inner txn:', {
                  amount,
                  type,
                  sender: innerTxn.sender,
                  receiver: innerTxn.paymentTransaction.receiver,
                })
                break
              }
            }
      ...
      <form method="dialog" className="modal-box max-w-3xl">
        ...
        <div className="mt-2 flex flex-col gap-4">
          <div className="flex flex-col gap-2">
            ...
            />
            {appAddress && <div className="alert alert-info text-xs break-all">App Address: {appAddress}</div>}
          </div>
